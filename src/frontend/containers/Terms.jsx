      ...
      <Container fixed>
        <div className='terms'>
          <p className='text-justify'>
            ...
            de su conocimiento que HJ Autopartes SA de CV, con domicilio en BLVD
            LOS ALAMOS #195 COLONIA LOS ALAMOS, NOGALES, SONORA 84085, México,
            es el responsable en término de la Ley de referencia de recabar los
            datos personales que le hemos solicitado, del uso que dé a los
            mismos y de su protección.Su información personal será utilizada
            para las siguientes finalidades: Proveerle los servicios y productos
            que ha solicitado; Notificarle sobre nuevos servicios o productos
            que tengan relación con los ya contratados o adquiridos;
